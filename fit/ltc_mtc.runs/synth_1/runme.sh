...
HD_PWD='C:/Users/Andy Peters/Documents/GitHub/ltc_mtc/fit/ltc_mtc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ltc_mtc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ltc_mtc.tcl
