...
HD_PWD='C:/Users/Andy Peters/Documents/GitHub/ltc_mtc/fit/ltc_mtc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ltc_mtc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ltc_mtc.tcl -notrace
