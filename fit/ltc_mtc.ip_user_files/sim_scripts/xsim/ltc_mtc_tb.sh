...
#
# Script generated by Vivado on Mon Apr 07 22:13:19 -0700 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot ltc_mtc_tb xil_defaultlib.ltc_mtc_tb xil_defaultlib.glbl -log elaborate.log
}
