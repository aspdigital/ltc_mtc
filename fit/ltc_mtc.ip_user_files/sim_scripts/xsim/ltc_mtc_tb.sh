...
#
# Script generated by Vivado on Thu May 15 19:56:03 -0700 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ltc_mtc_tb.sh
...
#
# Usage        : ltc_mtc_tb.sh
#                ltc_mtc_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ltc_mtc_tb.sh [-reset_run]
#                ltc_mtc_tb.sh [-reset_log]
#                ltc_mtc_tb.sh [-help]
#
...
# script info
echo -e "ltc_mtc_tb.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ltc_mtc_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --debug typical --mt 2 -generic_top "TX_FRAME_RATE=0"  -L xil_defaultlib -L xpm -L fifo_generator_v13_2_11 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot ltc_mtc_tb xil_defaultlib.ltc_mtc_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ltc_mtc_tb -key {Behavioral:sim_1:Functional:ltc_mtc_tb} -tclbatch cmd.tcl -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm fifo_generator_v13_2_11)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ltc_mtc_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ltc_mtc_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ltc_mtc_tb.sh [-help]\n\
Usage: ltc_mtc_tb.sh [-step]\n\
Usage: ltc_mtc_tb.sh [-lib_map_path]\n\
Usage: ltc_mtc_tb.sh [-reset_run]\n\
Usage: ltc_mtc_tb.sh [-reset_log]\n\
Usage: ltc_mtc_tb.sh [-keep_index]\n\
Usage: ltc_mtc_tb.sh [-noclean_files]\n\n\
